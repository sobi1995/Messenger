...
{
    public interface IUsersUserIdentityServiceJwt
    {
    ...
    public class UsersUserIdentityService : IUsersUserIdentityServiceJwt
    {
        ...
        public UsersUserIdentityService(
            IUnitOfWork uow,
        ...
        public Task<User> FindUserAsync(string username, string password)
        {
            ...
            return _users.FirstOrDefaultAsync(x => x.Mobile == username && x.Password == passwordHash);
        }
